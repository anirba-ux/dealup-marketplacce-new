...
export default function SearchFilterContent({
  ...
  return (
    <>
      ...
      <div className="mb-8">
        <h3 className="mb-4 text-lg font-bold text-[#1565d8]">
          Radius
        </h3>
            ...
            <button
              ...
              className={`rounded-full px-4 py-2 text-sm font-medium transition-all duration-300 ${
                selectedRadius === item
                  ...
                  : "border border-slate-300 bg-white text-slate-700 hover:border-[#1565d8] hover:bg-blue-50 hover:text-[#1565d8] dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200 dark:hover:border-blue-500 dark:hover:bg-slate-700 dark:hover:text-white"
              }`}
            >
              📍 {item} KM
            </button>
      ...
      <div>
        ...
        <div className="mt-5 flex flex-wrap gap-2">
          {[25000, 50000, 100000, 200000, 500000].map(
            (value) => (
              <button
                key={value}
                ...
                className={`
                  ...
                  ${
                    price === value
                      ? "bg-[#1565d8] text-white"
                      : "border border-slate-300 bg-white text-slate-700 hover:bg-blue-50 hover:text-[#1565d8] dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700 dark:hover:text-white"
                  }
                `}
              >
                {formatPrice(value)}
